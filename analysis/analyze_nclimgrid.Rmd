...
nclimgrid <- brick("input/raw/nclimgrid_tavg.nc")
...
writeRaster(nclimgrid_year_means, "input/processed/nclimgrid_years.tif", overwrite=TRUE)
...
writeRaster(nclimdiv_slopes_1895, "input/processed/nclimgrid_slopes_1895_2019.tif", overwrite=TRUE)
```
