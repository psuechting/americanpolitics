...
write_csv(climdiv_national, "input/processed/climdiv_national.csv")
...
```{r annual mean temperature, include=FALSE, eval=TRUE, echo=FALSE}
...
write_csv(climdiv_national_year, "input/processed/climdiv_national_2020.csv")
